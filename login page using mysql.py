...
class Login:
  ...
  def loginform(self):
    ...
    self.img=ImageTk.PhotoImage(file="Your_image.jpg")
  ...
  def login(self):
    ...
    if self.email_txt.get()=="" or self.password.get()=="":
      ...
      try:
       ...
       con=pymysql.connect(host='localhost',user='root',password='Sairam@1234',database='pythongui')
  ...
  def appscreen(self):
      ...
      label1=Label(Frame_login,text="Hi! Welcome To Sairam Login page",font=('times new roman',32,'bold'),fg="black",bg='white')

      label1.place(x=375,y=100)

      label2=Label(Frame_login,text="Here you can see  ",font=('times new roman',32,'bold'),fg="black",bg='white')

      label2.place(x=235,y=160)

      label3=Label(Frame_login,text="Logout Button",font=('times new roman',32,'bold'),fg="black",bg='white')
